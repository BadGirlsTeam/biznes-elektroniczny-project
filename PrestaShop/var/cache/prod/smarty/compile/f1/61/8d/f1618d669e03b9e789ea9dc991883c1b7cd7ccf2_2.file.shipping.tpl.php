...
function content_63bae1fc19e4a6_89362251 (Smarty_Internal_Template $_smarty_tpl) {
...
<?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_163433649463bae1fc14b436_34257056', 'step_content');
?>

<?php $_smarty_tpl->inheritance->endChild($_smarty_tpl, 'checkout/_partials/steps/checkout-step.tpl');
}
/* {block 'delivery_options'} */
class Block_64564986263bae1fc166b59_67109972 extends Smarty_Internal_Block
{
                  ...
                  <div class="row delivery-option js-delivery-option">
                    <div class="col-sm-1">
                      <span class="custom-radio float-xs-left">
                        <input type="radio" name="delivery_option[<?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['id_address']->value, ENT_QUOTES, 'UTF-8');?>
]" id="delivery_option_<?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['carrier']->value['id'], ENT_QUOTES, 'UTF-8');?>
" value="<?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['carrier_id']->value, ENT_QUOTES, 'UTF-8');?>
"<?php if ($_smarty_tpl->tpl_vars['delivery_option']->value == $_smarty_tpl->tpl_vars['carrier_id']->value) {?> checked<?php }?>>
                        <span></span>
                      </span>
                    </div>
                    <label for="delivery_option_<?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['carrier']->value['id'], ENT_QUOTES, 'UTF-8');?>
                        ...
                        <div class="col-sm-5 col-xs-12">
                          <div class="row carrier<?php if ($_smarty_tpl->tpl_vars['carrier']->value['logo']) {?> carrier-hasLogo<?php }?>">
                            ...
                            <div class="col-xs-12 col-md-4 carrier-logo">
                                <img src="<?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['carrier']->value['logo'], ENT_QUOTES, 'UTF-8');?>
" alt="<?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['carrier']->value['name'], ENT_QUOTES, 'UTF-8');?>
" loading="lazy" />
                            </div>
                            <?php }?>
                            <div class="col-xs-12 carriere-name-container<?php if ($_smarty_tpl->tpl_vars['carrier']->value['logo']) {?> col-md-8<?php }?>">
                              <span class="h6 carrier-name"><?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['carrier']->value['name'], ENT_QUOTES, 'UTF-8');?>
</span>
                            </div>
                          </div>
                        </div>
                        <div class="col-sm-4 col-xs-12">
                          <span class="carrier-delay"><?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['carrier']->value['delay'], ENT_QUOTES, 'UTF-8');?>
</span>
                        </div>
                        <div class="col-sm-3 col-xs-12">
                          <span class="carrier-price"><?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['carrier']->value['price'], ENT_QUOTES, 'UTF-8');?>
</span>
                        </div>
                      </div>
                    </label>
...
/* {/block 'delivery_options'} */
/* {block 'step_content'} */
class Block_163433649463bae1fc14b436_34257056 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'step_content' => 
  array (
    0 => 'Block_163433649463bae1fc14b436_34257056',
  ),
  'delivery_options' => 
  array (
    0 => 'Block_64564986263bae1fc166b59_67109972',
  ),
);
public function callBlock(Smarty_Internal_Template $_smarty_tpl) {
?>
...
"
      ...
      >
        <div class="form-fields">
          <?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_64564986263bae1fc166b59_67109972', 'delivery_options', $this->tplIndex);
?>
          ...
          <div class="order-options">
            <div id="delivery">
              ...
              <textarea rows="2" cols="120" id="delivery_message" name="delivery_message"><?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['delivery_message']->value, ENT_QUOTES, 'UTF-8');?>
</textarea>
            </div>
            ...
            <?php if ($_smarty_tpl->tpl_vars['gift']->value['allowed']) {?>
              <span class="custom-checkbox">
                ...
                <span><i class="material-icons rtl-no-flip checkbox-checked">&#xE5CA;</i></span>
                <label for="input_gift"><?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['gift']->value['label'], ENT_QUOTES, 'UTF-8');?>
</label >
              </span>
              ...
              <div id="gift" class="collapse<?php if ($_smarty_tpl->tpl_vars['gift']->value['isGift']) {?> in<?php }?>">
                ...
                <textarea rows="2" cols="120" id="gift_message" name="gift_message"><?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['gift']->value['message'], ENT_QUOTES, 'UTF-8');?>
</textarea>
              </div>
            <?php }?>
